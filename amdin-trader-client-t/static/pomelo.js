...
pomeloRequire.latest = function (name, returnPath) {
    ...
    if (semVerCandidates.length > 0) {
        var module = semVerCandidates.sort(pomeloRequire.helper.semVerSort).pop()
            .name;
...
pomeloRequire.register("pomelonode~pomelo-protobuf@master", function (
    exports,
    module
) {
    ...
    (function (exports, global) {
        ...
        typeof window == "undefined" ? module.exports : (this.protobuf = {}),
        this
    );
    ...
    (function (exports, global) {
                ...
                switch (proto.option) {
                    case "required":
                        if (typeof msg[name] === "undefined") {
                            console.warn(
                                "no property exist for required! name: %j, proto: %j, msg: %j",
                                name,
                                proto,
                                msg
                            );
                    ...
                    case "optional":
                        if (typeof msg[name] !== "undefined") {
                            var message =
                                ...
                                MsgEncoder.protos["message " + proto.type];

                            if (!!message && !checkMsg(msg[name], message)) {
                                console.warn(
                                    "inner proto error! name: %j, proto: %j, msg: %j",
                                    name,
                                    proto,
                                    msg
                                );
        ...
        function encodeProp(value, type, offset, buffer, protos) {
            switch (type) {
                ...
                default:
                    var message =
                        protos.__messages[type] || MsgEncoder.protos["message " + type];
        ...
        function decodeProp(type, protos) {
            switch (type) {
                ...
                default:
                    var message =
                        protos &&
                        (protos.__messages[type] || MsgDecoder.protos["message " + type]);
...
pomeloRequire.register("netease~pomelo-protocol@master", function (
    exports,
    module
) {
...
pomeloRequire.register("pomelonode~pomelo-jsclient-websocket@master", function (
    exports,
    module
) {
    (function () {
        ...
        var connect = function (params, url, cb) {
            ...
            if (
                window.localStorage &&
                window.localStorage.getItem("dicts") &&
                dictVersion === 0
            ) {
        ...
        var initData = function (data) {
            ...
            if (protosLocalStorage) {
                window.localStorage.setItem(
                    "protos",
                    JSON.stringify(protosLocalStorage)
                );
