(function () {
    ...
    var mp3Encoder, maxSamples = 1152, samplesMono, lame, config, dataBuffer,stream;
    ...
    var appendToBuffer = function (mp3Buf) {
        ...
        stream.push(new Int8Array(mp3Buf));
    };
...
//        mp3Encoder = new lame.Mp3Encoder(1, config.sampleRate || 44100, config.bitRate || 128);
        mp3Encoder = new lame.Mp3Encoder(1, config.sampleRate || 44100, config.bitRate || 8);
        clearBuffer();
        self.postMessage({
            cmd: 'init'
        });
