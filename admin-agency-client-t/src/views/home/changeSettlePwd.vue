<template>
    <div class="content settings">
        <div class="header">
            ...
            <div class="text">修改结算密码</div>
        </div>
        <div class="hint">请输入你需要修改的结算密码</div>
        <div class="formBox">
            <div class="formItem"><em>新密码：</em><input placeholder="请输入新密码" v-model="newPwd" type="password" autocomplete="off"></div>
            <div class="formItem"><em>确认密码：</em><input placeholder="请确认新密码" v-model="confirmPwd" type="password" autocomplete="off"></div>
...
export default class SelfInfo extends Vue {
  ...
  async updatePwd() {
    ...
    await xutil.myDispatch(this.$store, "UpdateSelfSettlePwd", tmp);
