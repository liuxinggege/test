    ...
    <div class="dashboard-outer">
        <el-card class="dashboard-second">
            <el-col class="toolbar1">
                <el-popover ref="popover1" placement="top" itle="标题" trigger="hover" content="二八杠游戏日志"></el-popover>
                <el-button v-popover:popover1 type="text" class="el-icon-info"></el-button>
                <span class="title">二八杠游戏日志</span>
            </el-col>
            <!--工具条-->
            <div>
                <span>用户ID</span>
            ...
            <!--列表-->
            <el-table :data="erbagangGameLog.erbagangGameLogData" border highlight-current-row style="width: 100%;" max-height="460">
            ...
            <el-col class="toolbar2">
                <el-pagination ref="pageRef" layout="sizes, prev, next" class="pag" @current-change="handleCurrentChange" @size-change="handleSizeChange" :current-page="page" :page-count="erbagangGameLog.totalCount" :page-sizes="[10,20,30,50]"></el-pagination>
            </el-col>
            <!-- 详细信息 -->
            <el-dialog :visible.sync="dialogErbagangVisible" width="80%">
                <el-col class="toolbar1">
                    <el-popover ref="popover1" placement="top" itle="标题" trigger="hover" content="二八杠游戏玩家日志"></el-popover>
                    <el-button v-popover:popover1 type="text" class="el-icon-info"></el-button>
                    <span class="title">玩家日志({{erbagangGameLog.gameId}})</span>
                </el-col>
                <!--列表-->
                <el-table :data="erbagangGameLog.ErbagangStageLog" border highlight-current-row style="width: 100%;">
...
import { ErbagangGameLogState } from "../../store/stateInterface";
...
export default class GameLog extends Vue {
    ...
    /*inital data*/
    erbagangGameLog: ErbagangGameLogState = this.$store.state
        .erbagangGameLog; //表单数据
    dialogErbagangVisible: boolean = false;
    userId: string = "";
    logTime: Date[] = [];
    page: number = 1; //当前页
    count: number = 10;
    ...
    loadData() {
        ...
        myDispatch(this.$store, "GetErbagangGameLog", queryItem).then(() => {
            this.setPagination();
          });
    }
    setPagination() {
      ...
      if (this.page === 1) {
        this.erbagangGameLog.totalCount = 1;
      }
      if (this.erbagangGameLog.next) {
    ...
    userDetail(index, row) {
        ...
        this.$store.commit("SET_CUBERBAGANGUSERDETAIL", payload);
    ...
    downloadExcel() {
        ...
        let queryItem: QueryItem = this.getQueryItem();
        myDispatch(this.$store, "GetErbagangGameLogExcel", queryItem).then(
            ret => {
