  ...
  <div class="dashboard-outer">
    <el-card class="dashboard-second">
      <el-col class="toolbar1">
        <el-popover ref="popover1" placement="top" itle="标题" trigger="hover" content="转账日志"></el-popover>
        <el-button v-popover:popover1 type="text" class="el-icon-info"></el-button>
        <span class="title">转账日志</span>
      </el-col>
      <!--工具条-->
      <div>
        <span>转账账号uid</span>
      ...
      <!-- 列表  -->
      <el-table :data="transferLog.transferLogData" border highlight-current-row style="width: 99%;" max-height="520">
...
export default class TransferLog extends Vue {
  ...
  /*inital data*/
  transferLog: TransferLogState = this.$store.state.transferLog; //表单数据
  ...
  loadData() {
    ...
    myDispatch(this.$store, "GetTransferLog", queryItem, true);
  }
  searchData() {
    this.page = 1;
    this.loadData();
  ...
  downloadExcel() {
    ...
    myDispatch(this.$store, "GetTransferLogExcel", queryItem).then(ret => {
