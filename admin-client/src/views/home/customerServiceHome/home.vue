<template>
    ...
    <el-tabs v-model="activeName" type="border-card" class="dashboard-dayOnline">
        ...
        <el-tab-pane v-for="pid in pids" :label="pid.name" :name="pid.pid" :key="pid.pid">
          <customerService-projectTodayOnline :pid="pid.pid" v-if="activeName==pid.pid"></customerService-projectTodayOnline>
        </el-tab-pane> 
    </el-tabs>
