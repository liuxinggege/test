<template>
    <div>
        <div id="chartLineYQ15" style="width:100%; height:630px;padding: 10px;"></div>
    </div>
</template>
...
export default class Total extends Vue {
    ...
    loadData() {
        console.log(document.getElementById("chartLineYQ15"));
        myDispatch(
            this.$store,
            ...
            let yData2: number[] = [];
            //echarts.dispose()
            this.chartLineYQ15 = echarts.init(
                document.getElementById("chartLineYQ15")
            );
            ...
            this.chartLineYQ15.showLoading({
                text: ""
            });
    ...
    drawLineChart(xData, yData1, yData2) {
        ...
        this.chartLineYQ15.hideLoading();
    }
}
</script>
