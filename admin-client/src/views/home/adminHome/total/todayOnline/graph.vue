        ...
        <el-card class="dashboard-winAndLose">
            ...
            <el-tabs v-model="activeName" style="margin: 10px">
                <el-tab-pane label="总计" name="first">
                    <totalSum v-if="activeName=='first'"></totalSum>
                </el-tab-pane>
                <el-tab-pane label="大厅" name="second">
                    <lobbyTotal v-if="activeName=='second'"></lobbyTotal>
                </el-tab-pane>
                <el-tab-pane label="金花" name="third">
                    <jinhua v-if="activeName=='third'"></jinhua>
                </el-tab-pane>
                <el-tab-pane label="牛牛" name="fourth">
                    <niuNiu v-if="activeName=='fourth'"></niuNiu>
                </el-tab-pane>
                <el-tab-pane label="百人牛牛" name="fifth">
                    <brNiuniu v-if="activeName=='fifth'"></brNiuniu>
                </el-tab-pane>
                <el-tab-pane label="血战" name="sixth">
                    <xueZhan v-if="activeName=='sixth'"></xueZhan>
                </el-tab-pane>
                <el-tab-pane label="梭哈" name="seventh">
                    <suoHa v-if="activeName=='seventh'"></suoHa>
                </el-tab-pane>
                <el-tab-pane label="斗地主" name="eighth">
                    <doudizhu v-if="activeName=='eighth'"></doudizhu>
                </el-tab-pane>
                <el-tab-pane label="德州扑克" name="ten5">
                    <dezhoupuke v-if="activeName=='ten5'"></dezhoupuke>
                </el-tab-pane>
                <el-tab-pane label="抢红包" name="ten6">
                    <qianghongbao v-if="activeName=='ten6'"></qianghongbao>
                </el-tab-pane>
                <el-tab-pane label="二八杠" name="ten7">
                    <erbagang v-if="activeName=='ten7'"></erbagang>
                </el-tab-pane>
                <el-tab-pane label="多福多财" name="ten8">
                    <duofuduocai v-if="activeName=='ten8'"></duofuduocai>
                </el-tab-pane>
                <el-tab-pane label="红黑" name="ninth">
                    <honghei v-if="activeName=='ninth'"></honghei>
                </el-tab-pane>
                <el-tab-pane label="龙虎斗" name="ten3">
                    <longhu v-if="activeName=='ten3'"></longhu>
                </el-tab-pane>
                <el-tab-pane label="捕鱼" name="ten">
                    <buyu v-if="activeName=='ten'"></buyu>
                </el-tab-pane>
                <el-tab-pane label="经典牛牛" name="ten1">
                    <jdniuniu v-if="activeName=='ten1'"></jdniuniu>
                </el-tab-pane>
                <el-tab-pane label="跑得快" name="ten2">
                    <paodekuai v-if="activeName=='ten2'"></paodekuai>
                </el-tab-pane>
                <el-tab-pane label="二人麻将" name="ten4">
                    <ermj v-if="activeName=='ten4'"></ermj>
                </el-tab-pane>
            </el-tabs>
        </el-card>
    </el-col>
...
export default class TodayWinLose extends Vue {
    ...
    async loadData() {
        await myDispatch(this.$store, "GetTodayAndYestRealOnline", {}, true).then(
            () => { }
        );
    }
}
