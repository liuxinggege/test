<template>
    <el-card class="todaySum">
        ...
        <el-row style="margin: 15px 0">
            ...
            <el-col :span="2" align="center" class="todayBar">
                <svg-icon icon-class="money" class-name="card-panel-icon" />{{Math.floor(todaySum.systemEachDayWinAndLose * 100)/100}}
                <br>
                <span class="gray">系统输赢</span>
            </el-col>
            <el-col :span="2" align="center" class="todayBar">
...
export default class Login extends Vue {
  ...
  loadData() {
    myDispatch(this.$store, "GetTodaySum",).then(() => {
