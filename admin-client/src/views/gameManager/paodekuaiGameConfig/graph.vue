...
export default class Graph extends Vue {
  //初始化数据
  GameEachDayUserWinAndLoseState: GameEachDayUserWinAndLoseState = this.$store.state.gameEachDayUserWinAndLose;
  gameEachDayUserWinAndLose: GameEachDayUserWinAndLose = this.GameEachDayUserWinAndLoseState.gameEachDayUserWinAndLose;
  valueTime = [null, null];
  chartLine: any;
  chartType: string = "PDK";
