...
const TGPIntegrationAPIServer = "https://staging.tgpaccess.com";
const LoginRegUrl = "https://ydwk.alvinsstore.com";
...
service.interceptors.request.use(
  async config => {
      ...
      // config.headers["X-Tgp-Accept"] = "json"; 
      let baseurl = sessionStorage.getItem("x-baseurl");
      if (!baseurl) {
        // let url = await chekLine();   // 跳过选择线测试路步骤
        sessionStorage.setItem("x-baseurl", LoginRegUrl);
        config.baseURL = LoginRegUrl;
      } else {
